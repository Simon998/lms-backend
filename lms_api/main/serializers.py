...
class TeacherSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id','full_name','detail', 'email', 'password','profile_img', 'qualification', 'mobile_no', 'skills', 'teacher_courses', 'skill_list', 'total_teacher_courses']
...
class NotificationSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id','notif_subject', 'teacher', 'student','notif_for','notif_read_status']
...
class QuizSerializer(serializers.ModelSerializer):
    class Meta:
        model = models.Quiz
        fields = ['id', 'teacher', 'title', 'description', 'assign_status', 'add_time']
...
class QuizQuestionSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'quiz', 'questions', 'ans1', 'ans2', 'ans3', 'ans4', 'correct_ans', 'add_time']
...
class AttemptQuizSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'student', 'quiz', 'question', 'correct_ans', 'add_time']
...
class StudyMaterialSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'course',  'title', 'description', 'remarks', 'upload']
...
class ContactSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'full_name', 'email', 'message', 'add_time']
